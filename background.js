...
function buildPrompt(sourceText) {
  ...
  //
  // 논문에서는 단순화가 곧 왜곡이 될 수 있다. '관련이 있다'를 '때문이다'로,
  // '일부 참가자에서'를 '사람들은'으로 바꾸면 틀린 내용을 인용하게 된다.
  // Leichte Sprache의 강한 단순화 중 이런 위험이 있는 규칙은 완화했다.
  // - 큰 수와 백분율을 '많은 사람'처럼 바꾸는 규칙: 연구의 숫자는 그대로 둔다
  // - 단서와 한계 표현은 지우거나 세게 바꾸지 않는다
...
- 다만 학술 용어와 전문 용어는 바꾸지 말고 그대로 씁니다.
- '~일 가능성이 있다', '~와 관련이 있다', '일부 참가자에서', '통계적으로 유의하지 않았다' 같은 단서와 한계는 절대 지우지 않습니다. '관련이 있다'를 '때문이다'로 바꾸는 것처럼 주장을 세게 바꾸지 않습니다.
- '다만', '~한 경우에는' 같은 조건과 예외는 빠뜨리지 않고 따로 한 문장으로 떼어 씁니다.
- 연구에 나온 숫자(참가자 수, 비율, 기간, 수치)는 바꾸지 않고 그대로 씁니다.
- 같은 대상은 늘 같은 단어로 부릅니다. 다른 말로 바꾸어 쓰지 않습니다.
- 비유, 관용구, 사자성어, 반어법을 쓰지 않습니다.
- 줄임말과 약자는 처음 나올 때 풀어서 씁니다.
- 부정문보다 긍정문으로 씁니다. 이중 부정은 쓰지 않습니다.
- 원문이 영어 등 다른 언어여도 한국어로 씁니다. 학술 용어는 처음 나올 때 한국어 용어 뒤에 원어를 괄호로 한 번 적습니다.
- '~습니다' 체로 씁니다.

1. [쉬운 말 변환 본문]
- 원문의 내용을 위 규칙에 따라 처음부터 끝까지 다시 씁니다.
- 원문에 있는 내용을 빠뜨리지 않고, 나온 순서대로 옮깁니다.
- 원문에 없는 내용을 새로 지어내지 않습니다. 해석이나 평가를 덧붙이지 않습니다.
- 원문이 목적, 방법, 결과, 결론으로 나뉘어 있으면 그 부분이 시작하는 줄 앞에 [목적], [방법], [결과], [결론]을 붙입니다.
- 본문 안에서는 낱말의 뜻을 따로 풀어 설명하지 않습니다. 뜻은 사전에 씁니다.

2. [어려운 용어 사전]
- 본문에 바꾸지 않고 남긴 학술 용어와 전문 용어를 빠짐없이 모두 넣습니다. 보통 4~10개입니다.
